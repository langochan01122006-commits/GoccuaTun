...
import { getAllVotes, voteForCharacter, unvoteForCharacter, subscribeToVotes, loginWithEmailPassword, registerWithEmailPassword, updateUserCustomProfile, logoutUser, auth } from "./firebase";
