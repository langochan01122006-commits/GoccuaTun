    ...
    <div className="flex flex-col h-[85vh] max-h-[750px] w-full rounded-3xl overflow-hidden glass-effect shadow-xl border border-blue-100/50 relative">
      ...
      >
        <input
          ...
          className="flex-1 px-4 py-3 bg-slate-50 border border-slate-200 rounded-2xl text-slate-700 placeholder-slate-400 text-base focus:outline-none focus:ring-2 focus:ring-blue-400 focus:bg-white transition"
          disabled={isLoading}
        />
        <button
          type="submit"
